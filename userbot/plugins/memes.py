...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await e.edit("Click [here](https://media.makeameme.org/created/trololololol-lolololol.jpg) to open this lit af repo.")
...
\n\n\nThanks to 🅱️ottom🅱️ext🅱️ot (@The_KILLER_BOB) for some of these."
})
